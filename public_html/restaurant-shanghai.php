    ...
    <div id="content-wrapper">
        ...
        <div id="profile-box">
            ...
            <div id="restaurant-img">
                ...
                <img src="img/shanghai.jpg" alt="Shanghai Pic" id="REST-pic">
        ...
        <p>
            ...
            <p>Shanghai Restaurant opened in Cluj in April of 1998, through the efforts of three partners – two Romanians and a Chinese.

From the very beginning, we have been committed to providing guests with a truly unique experience – fine dining and quality service in a pleasant atmosphere.

Throughout all these years, we continued to perfect our restaurants to surpass guests’ expectations, thus managing to gain a special place among Cluj’s varied restaurants..</p>
...
You won’t find anywhere a Shanghai Chicken prepared like we prepare!</p>
            ...
            <p>Since September 16, 2011, the opening date of the Beer workshop, there have played in our location a series of successful bands from the musical area of Iasi. 
</p>
       <div id="contact-info">
           <h1>Contact information</h1>
       <div id="social-wrapper">
          <h3>Social Handles</h3>
           <a href="https://www.facebook.com/ChineseRestaurantbyLi/"><img src="img/icons/facebook-white.svg" alt="Facebook" id="facebook-icon"></a>
           
           <a href="https://www.facebook.com/ChineseRestaurantbyLi/"><img src="img/icons/twitter-white.svg" alt="Twitter" id="twitter-icon"></a>
           </div>
...
+40 0232 452 557</p>
               ...
               <a href="http://www.restaurantshanghai.ro/en/index.htm">www.restaurantshanghai.ro</a>
               
               
               <img src="img/icons/black-back-closed-envelope-shape.svg" alt="E-Mail" id="mail-icon">
               <p>contact@restaurantshanghai.ro</p>
           </div>
           <div class="clear"></div>
           </div>
            </div>
