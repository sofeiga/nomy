       ...
       <div id="list">
           <div id="item-one" class="items">
               ...
               <div class="location-wrapper">
                   <img src="img/icons/location-white.svg" alt="Location" class="location-icon">
                   <p class="location-text">Iasi, Romania</p>
               </div>
               
               <div class="phone-wrapper">
                   <img src="img/icons/phone-receiver-white.svg" alt="Phone No." class="phone-icon">
                   <p class="phone-text">+40 0232 452 557</p>
               </div>
           ...
           <div id="item-two" class="items">
               ...
               <div class="phone-wrapper">
                   <img src="img/icons/phone-receiver-white.svg" alt="Phone No." class="phone-icon">
                   <p class="phone-text">+40 0760 013 014</p>
               </div>
           ...
           <div id="item-four" class="items">
               ...
               <div class="phone-wrapper">
                   <img src="img/icons/phone-receiver-white.svg" alt="Phone No." class="phone-icon">
                   <p class="phone-text">+40 0332 730 889</p>
               </div>
           ...
           <div id="item-five" class="items">
               ...
               <div class="phone-wrapper">
                   <img src="img/icons/phone-receiver-white.svg" alt="Phone No." class="phone-icon">
                   <p class="phone-text">+40 0232 266 666</p>
               </div>
